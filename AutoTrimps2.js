var ATversion='Zek v4.4.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://jddl68.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
